...
public actual fun skiaBackend(): GraphicsBackend? = SkikoBackend()

internal class SkikoBackend : GraphicsBackend {
    override val id: GraphicsBackendId = GraphicsBackendId.Skia

    override fun isAvailable(): Boolean = true

    override fun createRenderer(format: DisplayFormat): ComposeFrameRenderer = SkikoFrameRenderer(format)
}
